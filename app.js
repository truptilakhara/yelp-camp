...
const password = encodeURIComponent("yaBjlh4Tf0NvKCaG");
const db_url = `mongodb+srv://truptilakhara:${password}@cluster0.cixwxze.mongodb.net/?retryWrites=true&w=majority`;
